...
class ShopSpecCategory extends Shop
{
    ...
    {
        return $this->view->fetch('shop_spec_category/category_add');
    }
    ...
    public function categoryShow(){
        ...
        return $this->view->fetch('shop_spec_category/category_show',$output);
    }
    ...
    public function categoryEdit()
    {
        ...
        return $this->view->fetch('shop_spec_category/category_edit',$output);
    }

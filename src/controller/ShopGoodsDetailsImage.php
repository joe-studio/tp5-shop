...
class ShopGoodsDetailsImage extends Shop
{
    ...
    public function imageAdd()
    {
        ...
        return $this->view->fetch('shop_goods_details_image/image_add',$params);
    }
    ...
    public function imageShow(){
        ...
        return $this->view->fetch('shop_goods_details_image/image_show',$output);
    }
    ...
    public function imageEdit()
    {
        ...
        return $this->view->fetch('shop_goods_details_image/image_edit',$output);
    }
